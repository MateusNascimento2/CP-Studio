      ...
      <div className='w-[90%] ml-auto mr-auto lg:w-[960px] pt-[120px] pb-[150px] lg:ml-auto lg:mr-auto '>
          ...
          <div className='pt-4 pb-4 border-t-2 border-b-2'>
            <ul className='flex flex-wrap justify-center'>
              <li className='p-2 hover:scale-110 hover:transition-[1s]'>
                <img className='w-[176px] h-[120px]' src={pictures[0].img} alt="foto studio" onClick={() => setPicture(0)} />
              </li>
              <li className='p-2 hover:scale-110 hover:transition-[1s]'>
                <img className='w-[176px] h-[120px]' src={pictures[1].img} alt="foto studio" onClick={() => setPicture(1)} />
              </li>
              <li className='p-2 hover:scale-110 hover:transition-[1s]'>
                <img className='w-[176px] h-[120px]' src={pictures[2].img} alt="foto studio" onClick={() => setPicture(2)} />
              </li>
              <li className='p-2 hover:scale-110 hover:transition-[1s]'>
                <img className='w-[176px] h-[120px]' src={pictures[3].img} alt="foto studio" onClick={() => setPicture(3)} />
              </li>
              <li className='p-2 hover:scale-110 hover:transition-[1s]'>
                <img className='w-[176px] h-[120px]' src={pictures[4].img} alt="foto studio" onClick={() => setPicture(4)} />
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className='mb-10 flex flex-wrap justify-center lg:justify-start'>
          <div className='flex flex-col gap-4 w-[60%]'>
            <p className='bg-grey p-2 rounded-[5px] text-center'><span className='text-[18px]'><MdLocationPin className='inline mr-1 mb-1' />Av. das Américas, 18500 - Uprise Business Center, Sala 222, Recreio dos Bandeirantes | Rio de Janeiro / RJ | 22790-704</span></p>
            ...
            <p className='bg-grey p-2 rounded-[5px] text-center break-words'><span className='text-[18px]'><GrMail className='inline mr-1 mb-1 word-wrap' />Envie um e-mail: fitnesscp.studio@gmail.com</span></p>
          </div>
          <div className='ml-9 mt-6 lg:mt-0'>
            <p className='text-[18px]'><b>Segunda, quarta e Sexta</b>: 6h às 17h</p>
            <p className='text-[18px]'><b>Terça e quinta</b>: 6h às 21h</p>
          </div>
        </div>
      </div>
    </div>
