...
export default function Footer() {
    return (
        <div className='relative w-screen bg-darkgray z-10'>
            <div>
                <div className='border-b-2 p-4 flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-evenly'>
                    ...
                    <div className='flex justify-center flex-wrap mr-[-15px] ml-[-15px] text-center sm:w-[450px] mt-1 mb-2'>
                        ...
                        <div className='flex justify-center content-center pr-[2rem] pl-[2rem]'>
                            <span className='text-white inline-block'><MdLocationPin className='text-yellow-green text-lg inline mr-1 ' />Av. das Américas, 18500</span>
                        </div>
                    </div>
                    <div className='flex gap-2'>
                        <button><BsFacebook className='text-white hover:text-blue-facebook text-2xl' /></button>
                        <button><IoLogoWhatsapp className='text-white hover:text-green-wa text-2xl' /></button>
                        <button><AiFillInstagram className='text-white hover:text-purple-insta text-2xl' /></button>
                        <button><AiFillTwitterCircle className='text-white hover:text-blue-twitter text-2xl' /></button>
                    </div>
                </div>
                <div className='p-4 flex justify-center'>
                    <ul className='text-center'>
                        ...
                        <li className='p-[3px]'><a href='#portfolio' className='hover:text-white'>A Instrutora</a></li>
